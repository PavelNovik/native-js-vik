...
let man3FullCopy = { ...man3, friends: man3.friends.map((p) => ({ ...p })) }; //  your code
...
let man5FullCopy = {
  ...
  mother: {
    ...
    parents: man5.mother.parents.map((mp) => ({ ...mp })),
  },
}; //  your code
...
let man6FullCopy = {
  ...
  mother: {
    ...
    parents: man6.mother.parents.map((mp) => ({
      ...mp,
      favoriteDish: { ...mp.favoriteDish },
    })),
  },
}; //  your code
...
let man7FullCopy = {
  ...
  mother: {
    ...
    parents: man7.mother.parents.map((mp) => ({
      ...mp,
      favoriteDish: {
        ...mp.favoriteDish,
        ingredients: mp.favoriteDish.ingredients.map((fi) => ({ ...fi })),
      },
    })),
  },
}; //  your code
